...
const SLIDES: Slide[] = [
  {
    ...
    secondaryCta: { label: "Start Designing", href: "/customize" },
  ...
  },
  {
    ...
    cta: { label: "Open Studio", href: "/customize" },
    secondaryCta: { label: "See Examples", href: "/shop" },
    bgGradient: "from-stone-900 via-stone-800 to-stone-950",
  ...
  },
  {
    ...
    bgGradient: "from-stone-950 via-zinc-900 to-stone-950",
    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -right-32 top-1/4 h-96 w-96 rounded-full bg-stone-600 blur-[128px]"
          />
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 0.1 }}
            transition={{ duration: 1.2, delay: 0.2 }}
            className="absolute -left-32 bottom-1/4 h-96 w-96 rounded-full bg-stone-500 blur-[128px]"
          />
        </motion.div>
      </AnimatePresence>
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center px-6 lg:px-8">
        <AnimatePresence mode="wait">
          ...
          >
            <motion.h1
              className="font-display text-5xl font-bold leading-[1.1] tracking-tight text-white sm:text-6xl lg:text-8xl"
            >
              {slide.headline}{" "}
              <span className={`italic ${slide.accentColor}`}>
            ...
            <motion.p
              ...
              className="mt-6 max-w-xl text-lg leading-relaxed text-stone-400 sm:text-xl"
            >
              {slide.subtitle}
            </motion.p>
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            {SLIDES.map((s, i) => (
              <button
                ...
                className="group relative h-1 w-12 overflow-hidden rounded-full bg-stone-700/50"
              >
                {i === current && (
                  <motion.div
                ...
                {i !== current && (
                  <div className="absolute inset-0 rounded-full transition-colors group-hover:bg-stone-500/50" />
                )}
              </button>
            ))}
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-stone-600 text-stone-400 transition-all hover:border-stone-400 hover:text-white"
            >
